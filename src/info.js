...
// TODO Ниже представлен пример избыточности данных. Категория "Холодильники" существует в двух разных местах в виде двух разных объектов. В данном случае, когда подкатегории могу повторяться в двух и более разных категориях, необходимо вынести подкатегории в отдельный массив, и в категориях хранить ссылки на конкретные его элементы.
